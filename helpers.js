...
const createPeopleItem = (data) => {
  ...
  wrapper.appendChild(
    createItemFromURL("Homeworld", data.homeworld, (resourceName = "planets"))
  );
  wrapper.appendChild(
    createItemListFromURL("Species", data.species, (resourceName = "species"))
  );
  wrapper.appendChild(
    createItemListFromURL(
      "Starships",
      data.starships,
  ...
  wrapper.appendChild(
    createItemListFromURL("Films", data.films, (resourceName = "films"))
  );
...
const createShipItem = (data) => {
  ...
  wrapper.appendChild(
    createItemListFromURL("Pilots", data.pilots, (resourceName = "people"))
  );
  wrapper.appendChild(
    createItemListFromURL("Films", data.films, (resourceName = "films"))
  );
...
const createSpeciesItem = (data) => {
  ...
  wrapper.appendChild(
    createContentItem("Average Lifespan", data.average_lifespan)
  );
  ...
  wrapper.appendChild(
    createItemListFromURL("People", data.people, (resourceName = "people"))
  );
  wrapper.appendChild(
    createItemListFromURL("Films", data.films, (resourceName = "films"))
  );
...
const createFilmItem = (data) => {
  ...
  wrapper.appendChild(
    createItemListFromURL("Planets", data.planets, (resourceName = "planets"))
  );
  wrapper.appendChild(
    createItemListFromURL("Species", data.species, (resourceName = "species"))
  );
